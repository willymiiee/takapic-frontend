...
function hover(e) {
  e.stopPropagation();
  e.preventDefault();
  if (e.type == 'dragover') $(e.target).addClass('hover');
  else $(e.target).removeClass('hover');
}
// file selection
function handler(e) {
...
function showImage(f) {
  ...
  reader.onloadend = function() {
    ...
    $('#filedrag-project-photo')
      .css('background-image', 'url(' + reader.result + ')')
      .addClass('selected');
    // $('#filedrag .ph').css('display', 'none') //
    // $('#filedrag .selected-file').css('display', 'block').addClass("selected");
  };
