    ...
    <div>
      ...
      <ScrollToTop>
        <Switch>
          ...
          <Route path="/become-our-photographer/welcome-1" component={Step1Welcome} />
          <Route path="/become-our-photographer/step-1-1" component={Step1GrabCity} />
          <Route path="/become-our-photographer/step-1-2" component={Step1GrabInterestingSelfIntroduction} />
          <Route path="/become-our-photographer/step-1-3" component={Step1GrabCameraEquipment} />
          <Route path="/become-our-photographer/welcome-2" component={Step2Welcome} />
          <Route path="/become-our-photographer/step-2-1" component={Step2IndicatePrice} />
          <Route path="/become-our-photographer/step-2-2" component={Step2DateAvailability} />
          <Route path="/become-our-photographer/step-2-3" component={Step2IntiatePortofolio} />
          <Route path="/become-our-photographer/step-2-3" component={Step2IntiatePortofolio} />
          <Route path="/become-our-photographer/step-2-4a" component={Step2SetupMeetingPointA} />
          <Route path="/become-our-photographer/step-2-4b" component={Step2SetupMeetingPointB} />
          <Route path="/become-our-photographer/step-2-5" component={Step2Done} />
