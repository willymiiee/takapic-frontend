...
class SearchResult extends Component{
    ...
    componentDidMount(){
        ...
        fetch('https://api.takapic.com/v2/select_where/token/'+token+'/project/'+project+'/collection/'+collection+'/appid/'+appid+'/where_field/city/where_value/'+this.props.destination)
        .then(res => res.json())
        .then(data => {
            this.setState({
                data: data,
    ...
    render(){
        ...
        return(
            <div id="result">
                ...
                <div>
                    <div className="photo"><img src="images/photo/02.jpg" alt="" /></div>
                    <div className="photographer">
                        <div><img src="images/photographer/outlook-photography-jobs-2.jpg" alt=""/></div>
                        <h4>Sam Julian</h4>
                    </div>
                ...
                <div>
                    <div className="photo"><img src="images/photo/03.jpg" alt="" /></div>
                    <div className="photographer">
                        <div><img src="images/photographer/outlook-photography-jobs-2.jpg" alt=""/></div>
                        <h4>Sam Julian</h4>
                    </div>
                ...
                <div>
                    <div className="photo"><img src="images/photo/04.jpg" alt="" /></div>
                    <div className="photographer">
                        <div><img src="images/photographer/outlook-photography-jobs-2.jpg" alt=""/></div>
                        <h4>Sam Julian</h4>
                    </div>
                ...
                <div>
                    <div className="photo"><img src="images/photo/05.jpg" alt="" /></div>
                    <div className="photographer">
                        <div><img src="images/photographer/outlook-photography-jobs-2.jpg" alt=""/></div>
                        <h4>Sam Julian</h4>
                    </div>
                ...
                <div>
                    <div className="photo"><img src="images/photo/06.jpg" alt="" /></div>
                    <div className="photographer">
                        <div><img src="images/photographer/outlook-photography-jobs-2.jpg" alt=""/></div>
                        <h4>Sam Julian</h4>
                    </div>
