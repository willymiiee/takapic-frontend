    ...
    <div className="container">
      <div className="row">
        <div className="col-md-4 col-sm-12">
          ...
          <br /><br />
          <p>Capture every precious moment with TakaPic. TakaPic makes it easy for you to book professional photographer</p>
