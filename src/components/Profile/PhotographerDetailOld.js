...
class PhotographerDetail extends Component {
  ...
  componentDidMount() {
    ...
    // window.$('.circle-progress:eq(0)').generateCircleProgress({value: 0.40, gradient: ["cyan", "blue"]});
    // window.$('.circle-progress:eq(1)').generateCircleProgress({value: 0.60, gradient: ["red", "orange"]});
    // window.$('.circle-progress:eq(2)').generateCircleProgress({value: 0.80, gradient: ["red", "orange"]});
  }
