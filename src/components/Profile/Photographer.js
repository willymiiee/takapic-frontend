...
class Photographer extends Component{
  render(){
    return(
      <div className="container photographer-profile" style={{marginTop: '25px', marginBottom: '50px'}}>
        <div className="simple-profile" style={{textAlign: 'center'}}>
          <PhotoProfile
            src="images/sample/happy-client-02.jpg" size="100px"
            name="Photografer 4"
        ...
        <hr />
        <SlideShow
          photos={["images/sample/popular-location-01.jpg",
        ...
        <ul className="timeline">
          <li className="timeline-inverted">
            ...
            <div className="timeline-panel">
              <div className="timeline-heading">
                <h4 className="timeline-title"><b>Profile</b></h4>
              </div>
              <div className="timeline-body">
                <h2><b>Photographer 4</b></h2>
                <h2>Seoul, South Korea</h2>
                <Tag style={{marginRight: '5px'}}>Wedding</Tag><Tag>Party</Tag>
              </div>
            </div>
          </li>
          <li className="timeline-inverted">
            ...
            <div className="timeline-panel">
              <div className="timeline-heading">
                <h4 className="timeline-title"><b>Reviews</b></h4>
              </div>
              <div className="timeline-body">
                <div style={{marginBottom: '10px'}}>
                  <h3 style={{display: 'inline', marginRight: '10px'}}>Average</h3>
                  <Rate disabled={true} value={3.9} style={{display: 'inline-flex'}}/> 3.9
                </div>                
          ...
          <li className="timeline-inverted">
            ...
            <div className="timeline-panel">
              <div className="timeline-heading">
                <h4 className="timeline-title"><b>Comments (38)</b></h4>
              </div>
              <div className="timeline-body">
              </div>
            </div>
