        ...
        <div className="container">
            <div id="landing-page-top">
                ...
                <div id="landing-page-search">
                    <span>
                        <i className="fa fa-chevron-up search-toggle"></i>
                        <a href="">Clear all</a>
                    </span>
                    <Autocomplete
            ...
            <div className="row icons-container">
                <div className="col-sm-4">
                    <div className="icon-box-2 with-line">
                        ...
                        <p>Local photographers will guide you to the best locations in their city so you will not feel like a tourist</p>
                    </div>
                </div>
                <div className="col-sm-4">
                    <div className="icon-box-2 with-line">
                        <i className="im im-icon-Camera-5"></i>
                        <h3>Capture your precious moments</h3>
                        <p>Forget about selfies and photos taken by random strangers. You will be in the hands of a talented photographer with a creative eye ready to capture your best travel memories</p>
                    </div>
                </div>
                <div className="col-sm-4">
                    <div className="icon-box-2">
                        ...
                        <p>Only verified photographers are registered and you can view ratings and reviews left by travellers like you!</p>
                    </div>
                </div>
            </div>
        </div>
