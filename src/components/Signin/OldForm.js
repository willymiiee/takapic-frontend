        ...
        <Form ref="loginForm" model={this.state.login} rules={this.state.rules}>
          <Form.Item prop="email">
            <Input
              ...
              prepend={<i className="im im-icon-Mail" />}
            />
          </Form.Item>
          <Form.Item prop="password">
            <Input
              ...
              prepend={<i className="im im-icon-Lock-2" />}
            />
          </Form.Item>
          <button
            type="submit"
            className="button button-white border margin-top-5"
            name="login"
            value="Login"
          >
            Login
          ...
          },
          {
            validator: (rule, value, callback) => {
              if (value === '') {
                ...
                callback(
                  new Error(
                    'Only a-Z, 0-9 and _ characters allowed, first character must alphabet'
                  )
                );
        ...
        >
          <Form.Item prop="name">
            <Input
              ...
              prepend={<i className="im im-icon-Pen-6" />}
            />
          </Form.Item>
          <Form.Item prop="email">
            <Input
          ...
          <Form.Item prop="username">
            <Input
              ...
              prepend={<i className="im im-icon-User" />}
            />
          </Form.Item>
          <Form.Item prop="phone">
            <Input
              ...
              prepend={<i className="im im-icon-Phone" />}
            />
          </Form.Item>
          <Form.Item prop="password">
            <Input
