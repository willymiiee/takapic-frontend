...
export const checkUserById = function(uid) {
  return new Promise(function(resolve, reject) {
    axios
      .get(
        `https://api.takapic.com/v2/select_where/token/${token}/project/${project}/collection/user/appid/${appid}/where_field/user_id/where_value/${uid}`
      )
      .then(response => {
        if (response.data.Data === '0') {
          reject(new Error('User not found'));
...
export const checkUserByEmail = function(email) {
  return new Promise(function(resolve, reject) {
    axios
      .get(
        `https://api.takapic.com/v2/select_where/token/${token}/project/${project}/collection/user/appid/${appid}/where_field/email/where_value/${email}`
      )
      .then(response => {
        if (response.data.Data === '0') {
          reject(new Error('User not found'));
...
export const checkUserByUsername = function(username) {
  return new Promise(function(resolve, reject) {
    axios
      .get(
        `https://api.takapic.com/v2/select_where/token/${token}/project/${project}/collection/user/appid/${appid}/where_field/username/where_value/${username}`
      )
      .then(response => {
        if (response.data.Data === '0') {
          reject(new Error('User not found'));
...
export const updateUserId = function(email, uid) {
  ...
  return new Promise(function(resolve, reject) {
    axios
      .post('https://api.takapic.com/v2/update_where', body)
...
export const sendRegisterForm = function(
  name,
  email,
  password,
  username,
  ...
  return new Promise(function(resolve, reject) {
    axios
      .post('https://api.takapic.com/v2/insert', body)
